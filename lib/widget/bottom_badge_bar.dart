...
import 'bottom_badge_bar_item.dart';
...
class BottomBadgeBar extends StatefulWidget {
  ...
  BottomBadgeBar({
    ...
    bool showUnselectedLabels,
        ...
        assert(
          items.every((BottomBadgeBarItem item) => item.title != null) == true,
  ...
  final List<BottomBadgeBarItem> items;
  ...
  static BottomBadgeBarType _type(
    BottomBadgeBarType type,
    List<BottomBadgeBarItem> items,
  ) {
    if (type != null) {
      return type;
    }
    return items.length <= 3
        ? BottomBadgeBarType.fixed
        : BottomBadgeBarType.shifting;
  }
  ...
  static bool _defaultShowUnselected(BottomBadgeBarType type) {
    switch (type) {
      case BottomBadgeBarType.shifting:
        return false;
      case BottomBadgeBarType.fixed:
        return true;
    }
    assert(false);
    return false;
...
class _BottomNavigationBarState extends State<BottomBadgeBar>
  ...
  @override
  void didUpdateWidget(BottomBadgeBar oldWidget) {
